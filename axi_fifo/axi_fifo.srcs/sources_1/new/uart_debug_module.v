...
module UART_debug_module (
  ...
  task increment_cmd_ctr;
    if (eight_bit_ctr < 4'h3) eight_bit_ctr = eight_bit_ctr + 1;
    else begin
      if (sub_cmd_ctr <= 4'h5) begin
        eight_bit_ctr <= 4'h0;
  ...
  always @(posedge clk) begin
    ...
    case (state_ctr)
      ...
      WAIT_FOR_COMMAND: begin
        ...
        eight_bit_ctr <= 0;
        sub_cmd_ctr <= 0;
        if (command_avail == 1'b1) state_ctr <= TRANSMISSION_IDLE;
      end
