...
module axi_interconnect_v1_0_S00_AXIS #(
...
UART_Wrapper2 uartWrapper(.clk(S_AXIS_ACLK), .command_avail(1'b1), .command_to_send(serial_data), .ready(uart_ready_reg), .output_value(output_value), .uart_start(uart_start), .uart_active(uart_active), .state_debug(state_debug));
