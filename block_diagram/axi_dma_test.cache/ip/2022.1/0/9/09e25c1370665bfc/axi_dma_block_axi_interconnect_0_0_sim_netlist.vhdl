...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Wrapper is
  ...
  signal ctr0_carry_i_8_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \output_value[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \output_value[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \output_value[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \output_value[4]_i_2\ : label is "soft_lutpair9";
...
ctr0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(0) => ctr0_carry_n_3,
      CYINIT => '0',
      DI(3) => ctr0_carry_i_1_n_0,
      DI(2) => ctr0_carry_i_2_n_0,
      DI(1) => ctr0_carry_i_3_n_0,
      DI(0) => ctr0_carry_i_4_n_0,
      O(3 downto 0) => NLW_ctr0_carry_O_UNCONNECTED(3 downto 0),
      S(3) => ctr0_carry_i_5_n_0,
      S(2) => ctr0_carry_i_6_n_0,
      S(1) => ctr0_carry_i_7_n_0,
      S(0) => ctr0_carry_i_8_n_0
    );
\ctr0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \ctr0_carry__0_i_1_n_0\,
      DI(1) => \ctr0_carry__0_i_2_n_0\,
      DI(0) => breakPTR_reg(9),
      O(3 downto 0) => \NLW_ctr0_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \ctr0_carry__0_i_3_n_0\,
      S(2) => \ctr0_carry__0_i_4_n_0\,
      S(1) => \ctr0_carry__0_i_5_n_0\,
      S(0) => \ctr0_carry__0_i_6_n_0\
    );
...
\ctr0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => breakPTR_reg(19),
      DI(0) => breakPTR_reg(17),
      O(3 downto 0) => \NLW_ctr0_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => \ctr0_carry__1_i_1_n_0\,
      S(2) => \ctr0_carry__1_i_2_n_0\,
      S(1) => \ctr0_carry__1_i_3_n_0\,
      S(0) => \ctr0_carry__1_i_4_n_0\
    );
...
\ctr0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => breakPTR_reg(27),
      DI(0) => breakPTR_reg(25),
      O(3 downto 0) => \NLW_ctr0_carry__2_O_UNCONNECTED\(3 downto 0),
      S(3) => \ctr0_carry__2_i_3_n_0\,
      S(2) => \ctr0_carry__2_i_4_n_0\,
      S(1) => \ctr0_carry__2_i_5_n_0\,
      S(0) => \ctr0_carry__2_i_6_n_0\
    );
...
ctr0_carry_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\state_ctr[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3333333003033B38"
    )
        port map (
