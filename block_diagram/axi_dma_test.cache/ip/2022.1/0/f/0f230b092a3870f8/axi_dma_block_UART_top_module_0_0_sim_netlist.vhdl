...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Module is
  ...
  signal \FSM_sequential_state_ctr[1]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state_ctr[1]_i_3\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \value_reg[7]_i_1\ : label is "soft_lutpair4";
begin
  UartTx <= \^uarttx\;
...
\FSM_sequential_state_ctr[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0F00F0FF0F03AFA"
    )
        port map (
      I0 => tx_reg_0,
      I1 => \FSM_sequential_state_ctr[1]_i_2_n_0\,
      I2 => state_ctr(0),
      I3 => \FSM_sequential_state_ctr[1]_i_3_n_0\,
      I4 => state_ctr(2),
      I5 => state_ctr(1),
...
\FSM_sequential_state_ctr[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => state_ctr(0),
      I2 => \FSM_sequential_state_ctr[1]_i_3_n_0\,
      I3 => state_ctr(2),
      I4 => state_ctr(1),
...
\FSM_sequential_state_ctr[1]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => data_ctr_reg(1),
      I1 => data_ctr_reg(0),
      O => \FSM_sequential_state_ctr[1]_i_3_n_0\
    );
...
tx_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_top_module is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of active_i_1 : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of start_sending_tmp_i_1 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \value_reg[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \value_reg[2]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \value_reg[6]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \value_reg[7]_i_2\ : label is "soft_lutpair10";
begin
  active <= \^active\;
  ready <= \^ready\;
...
uart_module: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Module
     port map (
      CLK => outIBUF,
      CO(0) => \start_sending_tmp0_carry__2_n_1\,
      E(0) => uart_module_n_3,
      \FSM_sequential_current_state_reg[0]\(0) => current_state1,
...
\value_reg[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\value_reg[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
