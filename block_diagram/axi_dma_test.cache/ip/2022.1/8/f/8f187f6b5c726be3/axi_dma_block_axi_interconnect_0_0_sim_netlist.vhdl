...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_interconnect_v1_0_S00_AXIS is
  ...
  attribute SOFT_HLUTNM of \subdiv_ctr[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \subdiv_ctr[1]_i_1\ : label is "soft_lutpair9";
...
\fifo_ctr[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => writes_done,
      I3 => \FSM_sequential_state_ctr_reg_n_0_[0]\,
      I4 => \fifo_ctr[0]_i_2_n_0\,
      I5 => fifo_ctr(0),
      O => \fifo_ctr[0]_i_1_n_0\
    );
\fifo_ctr[0]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\fifo_ctr[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\subdiv_ctr[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FD02"
    )
        port map (
