...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Wrapper is
  port (
    ...
    \state_ctr_reg[0]_0\ : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Wrapper is
  ...
  signal eight_bit_ctr : STD_LOGIC;
  ...
  signal \state_ctr[1]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \NLW_ctr_reg[4]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state_ctr[1]_i_2\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \output_value[3]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \output_value[5]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \output_value[7]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \output_value[7]_i_6\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \state_ctr[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \state_ctr[1]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \state_ctr[2]_i_2\ : label is "soft_lutpair11";
begin
...
\FSM_sequential_state_ctr[1]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"04000000"
    )
        port map (
...
\ctr[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
\ctr_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_ctr_reg[4]_i_1_CO_UNCONNECTED\(3),
...
\output_value[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => ctr_reg(0),
      I2 => \output_value[2]_i_2_n_0\,
      I3 => ctr_reg(1),
      I4 => \output_value[0]_i_2_n_0\,
      O => \output_value[0]_i_1_n_0\
    );
\output_value[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"444911EE44491111"
    )
        port map (
      I0 => ctr_reg(2),
      I1 => ctr_reg(3),
...
\output_value[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => ctr_reg(4),
      I3 => ctr_reg(3),
      I4 => \output_value[1]_i_3_n_0\,
      I5 => ctr_reg(2),
      O => \output_value[1]_i_2_n_0\
    );
\output_value[1]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A6A5"
    )
        port map (
...
\output_value[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \output_value[5]_i_3_n_0\,
      I1 => \output_value[3]_i_2_n_0\,
      I2 => ctr_reg(0),
      I3 => \output_value[4]_i_2_n_0\,
      I4 => ctr_reg(1),
      I5 => \output_value[2]_i_2_n_0\,
      O => \output_value[2]_i_1_n_0\
    );
\output_value[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000AAAA2A6A"
    )
        port map (
      I0 => ctr_reg(5),
      I1 => ctr_reg(3),
...
\output_value[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \output_value[4]_i_2_n_0\,
      I2 => ctr_reg(0),
      I3 => \output_value[5]_i_3_n_0\,
      I4 => ctr_reg(1),
      I5 => \output_value[3]_i_2_n_0\,
...
\output_value[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => ctr_reg(0),
      I3 => \output_value[6]_i_2_n_0\,
      I4 => ctr_reg(1),
      I5 => \output_value[4]_i_2_n_0\,
      O => \output_value[4]_i_1_n_0\
    );
\output_value[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8AA00AA018DF18A0"
    )
        port map (
      I0 => ctr_reg(2),
      I1 => ctr_reg(4),
...
\output_value[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \output_value[6]_i_2_n_0\,
      I2 => ctr_reg(0),
      I3 => \output_value[5]_i_2_n_0\,
      I4 => ctr_reg(1),
      I5 => \output_value[5]_i_3_n_0\,
...
\output_value[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF00B8B8"
    )
        port map (
...
\state_ctr[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_interconnect_v1_0_S00_AXIS is
  ...
  signal fifo_available7_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of fifo_available_i_1 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of mst_exec_state_i_1 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \pointer_command_internal[0]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \pointer_command_internal[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \pointer_command_internal[2]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \pointer_commands[2]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \pointer_commands[3]_i_3\ : label is "soft_lutpair16";
