...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_interconnect_v1_0_S00_AXIS is
  ...
  signal fifo_ctr : STD_LOGIC;
  signal \fifo_ctr[0]_i_1_n_0\ : STD_LOGIC;
  signal \fifo_ctr[1]_i_1_n_0\ : STD_LOGIC;
  signal \fifo_ctr_reg_n_0_[0]\ : STD_LOGIC;
  signal \fifo_ctr_reg_n_0_[1]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \fifo_ctr[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of mst_exec_state_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \subdiv_ctr[0]_i_1\ : label is "soft_lutpair10";
...
\fifo_ctr[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"38"
    )
        port map (
...
\fifo_ctr[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4F80"
        ...
        port map (
      I0 => \fifo_ctr_reg_n_0_[0]\,
      I1 => \FSM_sequential_state_ctr_reg_n_0_[0]\,
      I2 => fifo_ctr,
      I3 => \fifo_ctr_reg_n_0_[1]\,
      O => \fifo_ctr[1]_i_1_n_0\
    );
\fifo_ctr[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000040004055"
    )
        port map (
      I0 => state_ctr(1),
