...
\FSM_sequential_current_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => start_signal,
      I4 => \FSM_sequential_current_state_reg[0]\(0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_top_module is
  ...
  signal \idle_ctr[0]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \ready1_carry__0_i_5_n_0\ : STD_LOGIC;
  signal \ready1_carry__0_i_6_n_0\ : STD_LOGIC;
  signal \ready1_carry__0_i_7_n_0\ : STD_LOGIC;
  signal \ready1_carry__0_n_0\ : STD_LOGIC;
  signal \ready1_carry__0_n_1\ : STD_LOGIC;
  signal \ready1_carry__0_n_2\ : STD_LOGIC;
  signal \ready1_carry__0_n_3\ : STD_LOGIC;
  ...
  signal \ready1_carry__1_n_1\ : STD_LOGIC;
  signal \ready1_carry__1_n_2\ : STD_LOGIC;
  signal \ready1_carry__1_n_3\ : STD_LOGIC;
  signal \ready1_carry__2_i_1_n_0\ : STD_LOGIC;
  signal \ready1_carry__2_i_2_n_0\ : STD_LOGIC;
  signal \ready1_carry__2_n_3\ : STD_LOGIC;
  ...
  signal ready1_carry_n_1 : STD_LOGIC;
  signal ready1_carry_n_2 : STD_LOGIC;
  signal ready1_carry_n_3 : STD_LOGIC;
  ...
  signal \NLW_ready1_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  attribute COMPARATOR_THRESHOLD of ready1_carry : label is 11;
  attribute COMPARATOR_THRESHOLD of \ready1_carry__0\ : label is 11;
  attribute COMPARATOR_THRESHOLD of \ready1_carry__1\ : label is 11;
  attribute COMPARATOR_THRESHOLD of \ready1_carry__2\ : label is 11;
...
ready1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2) => ready1_carry_n_1,
      CO(1) => ready1_carry_n_2,
      CO(0) => ready1_carry_n_3,
      CYINIT => '0',
      DI(3) => ready1_carry_i_1_n_0,
      DI(2) => ready1_carry_i_2_n_0,
      DI(1) => '0',
...
\ready1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2) => \ready1_carry__0_n_1\,
      CO(1) => \ready1_carry__0_n_2\,
      CO(0) => \ready1_carry__0_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \ready1_carry__0_i_1_n_0\,
      DI(1) => \ready1_carry__0_i_2_n_0\,
      DI(0) => \ready1_carry__0_i_3_n_0\,
      O(3 downto 0) => \NLW_ready1_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \ready1_carry__0_i_4_n_0\,
      S(2) => \ready1_carry__0_i_5_n_0\,
      S(1) => \ready1_carry__0_i_6_n_0\,
      S(0) => \ready1_carry__0_i_7_n_0\
    );
\ready1_carry__0_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\ready1_carry__0_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\ready1_carry__0_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\ready1_carry__0_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\ready1_carry__0_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\ready1_carry__0_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\ready1_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2) => \ready1_carry__1_n_1\,
      CO(1) => \ready1_carry__1_n_2\,
      CO(0) => \ready1_carry__1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\ready1_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_ready1_carry__2_CO_UNCONNECTED\(3 downto 2),
      CO(1) => ready1,
      CO(0) => \ready1_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      ...
      S(3 downto 2) => B"00",
      S(1) => \ready1_carry__2_i_1_n_0\,
      S(0) => \ready1_carry__2_i_2_n_0\
    );
...
ready1_carry_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
ready1_carry_i_3: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\start_ctr[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^debug_pin\ : STD_LOGIC_VECTOR ( 1 downto 0 );
begin
  debug_pin(3) <= \<const0>\;
  debug_pin(2) <= \<const0>\;
  debug_pin(1 downto 0) <= \^debug_pin\(1 downto 0);
