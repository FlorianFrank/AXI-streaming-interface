...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Module is
  ...
  signal \FSM_sequential_state_ctr[2]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state_ctr[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_sequential_state_ctr[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_sequential_state_ctr[2]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \FSM_sequential_state_ctr[2]_i_4\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \data_ctr[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_ctr[1]_i_1\ : label is "soft_lutpair6";
...
\FSM_sequential_state_ctr[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"34"
        ...
        port map (
      I0 => state_ctr(2),
      I1 => \FSM_sequential_state_ctr[2]_i_2_n_0\,
      I2 => state_ctr(0),
...
\FSM_sequential_state_ctr[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I0 => state_ctr(0),
      I1 => state_ctr(2),
      I2 => \FSM_sequential_state_ctr[2]_i_2_n_0\,
      I3 => state_ctr(1),
      O => \FSM_sequential_state_ctr[1]_i_1_n_0\
    );
\FSM_sequential_state_ctr[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0F80"
    )
        port map (
...
\FSM_sequential_state_ctr[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAAAAEA"
        ...
        port map (
      I0 => \FSM_sequential_state_ctr[2]_i_3_n_0\,
      I1 => data_ctr,
      I2 => \FSM_sequential_state_ctr[2]_i_4_n_0\,
      I3 => data_ctr_reg(3),
      I4 => data_ctr_reg(4),
      I5 => data_ctr_reg(5),
...
\FSM_sequential_state_ctr[2]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_top_module is
  ...
  signal value_reg_reg : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \value_reg[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \value_reg[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \value_reg[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \value_reg[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \value_reg[4]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \value_reg[7]_i_3\ : label is "soft_lutpair8";
begin
  ready <= \^ready\;
...
uart_module: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Module
     port map (
      ...
      CO(0) => current_state1,
      E(0) => uart_module_n_4,
      \FSM_sequential_current_state_reg[0]\ => uart_module_n_1,
      Q(7 downto 0) => value_reg_reg(7 downto 0),
      UartTx => UartTx,
...
\value_reg[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\value_reg[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\value_reg[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6AAAAAAAAAAAAAAA"
    )
        port map (
...
\value_reg[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6AAAAAAAAAAAAAAA"
    )
        port map (
      ...
      I1 => value_reg_reg(5),
      I2 => value_reg_reg(3),
      I3 => \value_reg[7]_i_3_n_0\,
      I4 => value_reg_reg(4),
      I5 => value_reg_reg(6),
      O => \p_0_in__0\(7)
    );
\value_reg[7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
