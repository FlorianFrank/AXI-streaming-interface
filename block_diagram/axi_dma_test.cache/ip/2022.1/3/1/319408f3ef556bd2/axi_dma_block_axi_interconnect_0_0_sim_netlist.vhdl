...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_interconnect_v1_0_S00_AXIS is
  ...
  signal \subdiv_ctr[1]_i_2_n_0\ : STD_LOGIC;
  signal \subdiv_ctr[2]_i_1_n_0\ : STD_LOGIC;
  signal \subdiv_ctr[2]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \fifo_ctr[0]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \subdiv_ctr[1]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \subdiv_ctr[2]_i_2\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \write_pointer[1]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \write_pointer[1]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \write_pointer[2]_i_12\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \write_pointer[2]_i_9\ : label is "soft_lutpair12";
...
\subdiv_ctr[1]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0220"
    )
        port map (
      ...
      I3 => \subdiv_ctr_reg_n_0_[1]\,
      O => \subdiv_ctr[1]_i_2_n_0\
    );
\subdiv_ctr[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAFBFFFFAA080000"
    )
        port map (
      I0 => \subdiv_ctr[2]_i_2_n_0\,
      I1 => \uart_start0_carry__2_n_1\,
      I2 => writes_done,
      I3 => state_ctr(0),
      I4 => \fifo_ctr[31]_i_4_n_0\,
