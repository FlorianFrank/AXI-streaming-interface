...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Wrapper is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state_ctr[4]_i_2\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \eight_bit_ctr[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \eight_bit_ctr[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \output_value[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \output_value[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \output_value[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \output_value[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \output_value[4]_i_1\ : label is "soft_lutpair11";
...
\output_value[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00E800F0"
    )
        port map (
...
\output_value[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00340030"
    )
        port map (
...
\state_debug[1]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
        ...
        port map (
      I0 => \FSM_onehot_state_ctr_reg_n_0_[2]\,
      I1 => \FSM_onehot_state_ctr_reg_n_0_[3]\,
      O => \^state_debug\(1)
    );
