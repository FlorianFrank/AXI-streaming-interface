...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Wrapper2 is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state_ctr[1]_i_2\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \output_value[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \output_value[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \output_value[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \output_value[4]_i_2\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \sub_cmd_ctr[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sub_cmd_ctr[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sub_cmd_ctr[1]_i_3\ : label is "soft_lutpair9";
begin
...
\output_value[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\output_value[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\output_value[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
