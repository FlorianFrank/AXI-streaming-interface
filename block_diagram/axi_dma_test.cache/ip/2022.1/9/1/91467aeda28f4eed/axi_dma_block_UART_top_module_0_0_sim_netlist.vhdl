...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Module is
  ...
  attribute SOFT_HLUTNM of finished_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of ready_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of tx_i_3 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \value_reg[7]_i_1\ : label is "soft_lutpair3";
begin
  UartTx <= \^uarttx\;
...
active_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
