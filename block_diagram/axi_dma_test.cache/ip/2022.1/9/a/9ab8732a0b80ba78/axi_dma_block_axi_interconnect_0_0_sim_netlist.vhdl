...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_interconnect_v1_0_S00_AXIS is
  port (
    ...
    out_ptr : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_interconnect_v1_0_S00_AXIS is
  ...
  signal \written_ctr_reg_n_0_[0]\ : STD_LOGIC;
  signal \written_ctr_reg_n_0_[1]\ : STD_LOGIC;
  signal \written_ctr_reg_n_0_[2]\ : STD_LOGIC;
  signal \written_ctr_reg_n_0_[3]\ : STD_LOGIC;
  signal \written_ctr_reg_n_0_[4]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \written_ctr[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \written_ctr[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \written_ctr[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \written_ctr[4]_i_3\ : label is "soft_lutpair8";
begin
...
\out_write_ptr_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => '1',
      D => \written_ctr_reg_n_0_[1]\,
      Q => out_ptr(1),
      R => '0'
    );
\out_write_ptr_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => '1',
      D => \written_ctr_reg_n_0_[2]\,
      Q => out_ptr(2),
      R => '0'
    );
\out_write_ptr_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => '1',
      D => \written_ctr_reg_n_0_[3]\,
      Q => out_ptr(3),
      R => '0'
    );
\out_write_ptr_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => '1',
      D => \written_ctr_reg_n_0_[4]\,
      Q => out_ptr(4),
      R => '0'
    );
...
\output_value[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
        ...
        port map (
      I0 => \written_ctr_reg_n_0_[2]\,
      I1 => \written_ctr_reg_n_0_[3]\,
      I2 => \written_ctr_reg_n_0_[0]\,
      I3 => \written_ctr_reg_n_0_[1]\,
      I4 => \written_ctr_reg_n_0_[4]\,
...
stream_data_fifo_reg_0_7_0_5: unisim.vcomponents.RAM32M
     port map (
      ...
      ADDRA(2) => \written_ctr_reg_n_0_[2]\,
      ADDRA(1) => \written_ctr_reg_n_0_[1]\,
      ADDRA(0) => \written_ctr_reg_n_0_[0]\,
      ADDRB(4 downto 3) => B"00",
      ADDRB(2) => \written_ctr_reg_n_0_[2]\,
      ADDRB(1) => \written_ctr_reg_n_0_[1]\,
      ADDRB(0) => \written_ctr_reg_n_0_[0]\,
      ADDRC(4 downto 3) => B"00",
      ADDRC(2) => \written_ctr_reg_n_0_[2]\,
      ADDRC(1) => \written_ctr_reg_n_0_[1]\,
      ADDRC(0) => \written_ctr_reg_n_0_[0]\,
...
stream_data_fifo_reg_0_7_0_5_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
      I0 => \written_ctr_reg_n_0_[4]\,
      I1 => \written_ctr_reg_n_0_[3]\,
...
stream_data_fifo_reg_0_7_6_7: unisim.vcomponents.RAM32X1D
     port map (
      ...
      D => s00_axis_tdata(6),
      DPO => output_value0(6),
      DPRA0 => \written_ctr_reg_n_0_[0]\,
      DPRA1 => \written_ctr_reg_n_0_[1]\,
      DPRA2 => \written_ctr_reg_n_0_[2]\,
      DPRA3 => '0',
      DPRA4 => '0',
...
\written_ctr[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"66966666"
        ...
        port map (
      I0 => \written_ctr_reg_n_0_[1]\,
      I1 => \written_ctr_reg_n_0_[0]\,
      I2 => state_ctr(0),
      I3 => uart_active,
      I4 => state_ctr(1),
...
\written_ctr[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => uart_active,
      I3 => state_ctr(0),
      I4 => \written_ctr_reg_n_0_[1]\,
      I5 => \written_ctr_reg_n_0_[0]\,
...
\written_ctr[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => \written_ctr_reg_n_0_[2]\,
      I1 => \written_ctr_reg_n_0_[3]\,
      I2 => \written_ctr[4]_i_3_n_0\,
      I3 => \written_ctr_reg_n_0_[1]\,
      I4 => \written_ctr_reg_n_0_[0]\,
...
\written_ctr[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => s00_axis_tvalid,
      I1 => \^mst_exec_state_reg_0\,
      I2 => \written_ctr_reg_n_0_[3]\,
      I3 => \written_ctr_reg_n_0_[4]\,
      I4 => \written_ctr[4]_i_3_n_0\,
      O => \written_ctr[4]_i_1_n_0\
    );
\written_ctr[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \written_ctr_reg_n_0_[2]\,
      I1 => \written_ctr_reg_n_0_[3]\,
      I2 => \written_ctr_reg_n_0_[4]\,
      I3 => \written_ctr[4]_i_3_n_0\,
      I4 => \written_ctr_reg_n_0_[1]\,
      I5 => \written_ctr_reg_n_0_[0]\,
      O => \written_ctr[4]_i_2_n_0\
    );
\written_ctr[4]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\written_ctr_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => s00_axis_aclk,
      CE => \written_ctr[4]_i_1_n_0\,
      D => \written_ctr[0]_i_1_n_0\,
      Q => \written_ctr_reg_n_0_[0]\,
      R => '0'
    );
...
\written_ctr_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axis_aclk,
      CE => \written_ctr[4]_i_1_n_0\,
      D => \written_ctr[4]_i_2_n_0\,
      Q => \written_ctr_reg_n_0_[4]\,
      R => '0'
    );
end STRUCTURE;
library IEEE;
...
axi_interconnect_v1_0_S00_AXIS_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_interconnect_v1_0_S00_AXIS
     port map (
      ...
      out_ptr(4 downto 0) => out_ptr(4 downto 0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^out_ptr\ : STD_LOGIC_VECTOR ( 4 downto 0 );
