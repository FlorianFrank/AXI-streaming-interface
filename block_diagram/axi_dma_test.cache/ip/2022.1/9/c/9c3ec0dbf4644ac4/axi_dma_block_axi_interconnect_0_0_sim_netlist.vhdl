...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Wrapper is
  ...
  signal \FSM_onehot_state_ctr_reg_n_0_[4]\ : STD_LOGIC;
  ...
  signal output_value0 : STD_LOGIC;
  ...
  signal \state_ctr[2]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \state_ctr[1]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \state_ctr[2]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \state_ctr[2]_i_3\ : label is "soft_lutpair8";
begin
...
\state_ctr[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \FSM_onehot_state_ctr_reg_n_0_[0]\,
      I3 => uart_active,
...
\state_ctr[2]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F8888888"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_interconnect_v1_0_S00_AXIS is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of fifo_available_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of mst_exec_state_i_1 : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \pointer_command_internal[2]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \pointer_commands[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \pointer_commands[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \pointer_commands[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \pointer_commands[3]_i_3\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \pointer_commands[3]_i_4\ : label is "soft_lutpair12";
...
begin
  ...
  out_ptr(1) <= \<const0>\;
  out_ptr(0) <= \<const0>\;
  output_value(7) <= \<const1>\;
  output_value(6) <= \<const1>\;
  output_value(5) <= \<const0>\;
  output_value(4) <= \<const0>\;
  output_value(3) <= \<const0>\;
  output_value(2) <= \<const1>\;
  output_value(1) <= \<const0>\;
  output_value(0) <= \<const1>\;
