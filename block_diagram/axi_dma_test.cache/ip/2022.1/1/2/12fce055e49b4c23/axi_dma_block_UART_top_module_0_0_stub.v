...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ axi_dma_block_UART_top_module_0_0_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(value, start_signal, clk_100MHZ, UartRx, UartTx, 
  active, ready, debug_pin)
/* synthesis syn_black_box black_box_pad_pin="value[7:0],start_signal,clk_100MHZ,UartRx,UartTx,active,ready,debug_pin[3:0]" */;
  input [7:0]value;
  input start_signal;
  input clk_100MHZ;
  input UartRx;
