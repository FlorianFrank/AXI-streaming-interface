...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Wrapper2 is
  ...
  signal \sub_cmd_ctr[2]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state_ctr[2]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \state_ctr[2]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \sub_cmd_ctr[2]_i_3\ : label is "soft_lutpair8";
...
\sub_cmd_ctr[2]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\sub_cmd_ctr[2]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_interconnect_v1_0_S00_AXIS is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FIFO_GEN[0].stream_data_fifo[0][4][0][7]_i_3\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \pointer_command_internal[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \pointer_command_internal[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \pointer_command_internal[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \pointer_command_internal[2]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \pointer_commands[1]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \pointer_commands[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \pointer_commands[3]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \pointer_commands[3]_i_4\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of writes_done_i_2 : label is "soft_lutpair14";
begin
...
\FIFO_GEN[0].stream_data_fifo[0][0][0][7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \FIFO_GEN[0].stream_data_fifo[0][0][0][7]_i_2_n_0\,
      I3 => s00_axis_tstrb(0),
      O => \FIFO_GEN[0].stream_data_fifo[0][0][0][7]_i_1_n_0\
    );
\FIFO_GEN[0].stream_data_fifo[0][0][0][7]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\FIFO_GEN[0].stream_data_fifo[0][4][0][7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\FIFO_GEN[0].stream_data_fifo[0][4][0][7]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000080"
    )
        port map (
...
\FIFO_GEN[1].stream_data_fifo[0][4][1][7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\FIFO_GEN[2].stream_data_fifo[0][4][2][7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\FIFO_GEN[3].stream_data_fifo[0][4][3][7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\pointer_commands[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => pointer_commands(1),
      I2 => \pointer_command_internal[2]_i_2_n_0\,
      I3 => \pointer_commands[3]_i_4_n_0\,
      I4 => pointer_commands(3),
