...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Wrapper is
  port (
    ...
    \FSM_sequential_state_ctr_reg[2]_0\ : in STD_LOGIC
  );
...
\FSM_sequential_state_ctr[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\FSM_sequential_state_ctr[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"26"
    )
        port map (
...
\FSM_sequential_state_ctr[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\state_ctr[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => uart_active,
      I1 => \state_ctr__0\(1),
      I2 => \FSM_sequential_state_ctr_reg[2]_0\,
      I3 => \state_ctr__0\(0),
      I4 => \state_ctr__0\(2),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_interconnect_v1_0_S00_AXIS is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of fifo_available_i_1 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of mst_exec_state_i_1 : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \pointer_command_internal[2]_i_2\ : label is "soft_lutpair11";
...
uartWrapper: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Wrapper
     port map (
      \FSM_sequential_state_ctr_reg[2]_0\ => command_ready_reg_n_0,
