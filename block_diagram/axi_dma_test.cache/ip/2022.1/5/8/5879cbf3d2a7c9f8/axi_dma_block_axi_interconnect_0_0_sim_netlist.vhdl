...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_interconnect_v1_0_S00_AXIS is
  ...
  signal in5 : STD_LOGIC_VECTOR ( 2 downto 1 );
  signal mst_exec_state_i_1_n_0 : STD_LOGIC;
  signal \^mst_exec_state_reg_0\ : STD_LOGIC;
  signal \output_value0__2\ : STD_LOGIC;
  ...
  signal \output_value_reg[7]_i_7_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \output_value[7]_i_3\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \subdiv_ctr[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \subdiv_ctr[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \subdiv_ctr[2]_i_2\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of writes_done_i_2 : label is "soft_lutpair11";
begin
...
fifo_ctr0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      O(1 downto 0) => in5(2 downto 1),
      S(3 downto 2) => B"00",
      S(1 downto 0) => fifo_ctr(2 downto 1)
    );
\fifo_ctr[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EEFEFFFE11000000"
    )
        port map (
      I0 => state_ctr(2),
      I1 => state_ctr(1),
...
\fifo_ctr[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8F80"
    )
        port map (
...
\fifo_ctr[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8F80"
    )
        port map (
...
\fifo_ctr[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"11010001"
    )
        port map (
...
\output_value[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CCFFAAF0CC00AAF0"
        ...
        port map (
      I0 => \output_value_reg[7]_i_4_n_0\,
      I1 => \output_value_reg[7]_i_5_n_0\,
      I2 => \stream_data_fifo__55\(7),
      I3 => \subdiv_ctr_reg_n_0_[1]\,
      I4 => \subdiv_ctr_reg_n_0_[0]\,
      I5 => \output_value_reg[7]_i_7_n_0\,
      O => \output_value[7]_i_2_n_0\
    );
\output_value[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AAA8"
    )
        port map (
...
\output_value_reg[7]_i_4\: unisim.vcomponents.MUXF7
     port map (
      I0 => \output_value[7]_i_8_n_0\,
      I1 => \output_value[7]_i_9_n_0\,
...
\output_value_reg[7]_i_5\: unisim.vcomponents.MUXF7
     port map (
      ...
      I1 => \output_value[7]_i_11_n_0\,
      O => \output_value_reg[7]_i_5_n_0\,
      S => fifo_ctr(2)
    );
\output_value_reg[7]_i_6\: unisim.vcomponents.MUXF7
     port map (
      I0 => \output_value[7]_i_12_n_0\,
      I1 => \output_value[7]_i_13_n_0\,
      O => \stream_data_fifo__55\(7),
      S => fifo_ctr(2)
    );
\output_value_reg[7]_i_7\: unisim.vcomponents.MUXF7
     port map (
      I0 => \output_value[7]_i_14_n_0\,
      I1 => \output_value[7]_i_15_n_0\,
      O => \output_value_reg[7]_i_7_n_0\,
      S => fifo_ctr(2)
    );
\subdiv_ctr[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFF0C00000050"
    )
        port map (
...
\subdiv_ctr[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF2000"
    )
        port map (
...
\subdiv_ctr[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00FF8000"
    )
        port map (
...
\subdiv_ctr[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"000D"
    )
        port map (
...
\subdiv_ctr_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
