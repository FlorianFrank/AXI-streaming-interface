...
#set_property PACKAGE_PIN G17 [get_ports {output_value_0[2]}]
#set_property PACKAGE_PIN N15 [get_ports {output_value_0[1]}]
#set_property PACKAGE_PIN G14 [get_ports {output_value_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports UartRx_0]
set_property IOSTANDARD LVCMOS33 [get_ports UartTx_0]
set_property PACKAGE_PIN Y11 [get_ports UartTx_0]
set_property PACKAGE_PIN Y12 [get_ports UartRx_0]



set_property PACKAGE_PIN M14 [get_ports {debug_pin_0[0]}]
set_property PACKAGE_PIN N16 [get_ports {debug_pin_0[1]}]
set_property PACKAGE_PIN P14 [get_ports {debug_pin_0[2]}]
set_property PACKAGE_PIN R14 [get_ports {debug_pin_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {debug_pin_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {debug_pin_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {debug_pin_0[1]}]
set_property PACKAGE_PIN G14 [get_ports {state_debug_0[3]}]
set_property PACKAGE_PIN N15 [get_ports {state_debug_0[2]}]
set_property PACKAGE_PIN G17 [get_ports {state_debug_0[1]}]
set_property PACKAGE_PIN L15 [get_ports {state_debug_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {debug_pin_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {state_debug_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {state_debug_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {state_debug_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {state_debug_0[0]}]
